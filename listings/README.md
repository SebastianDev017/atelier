...
This folder holds the metadata used to submit **Atelier V4** to the Shopify Theme Store.
...
**Gallery**, and **Botanic**. The full visual contract lives in `../DESIGN.md` and `../TOKENS.md`;
